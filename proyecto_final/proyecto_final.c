...
void cambios(struct almacen a[]){
	...
	if(buscar_b(a,buscar,&donde)){
		...
		switch(opc){
			case 1:
			     printf("\nPrecio de Venta: ");
		         scanf("%f",&a[donde].pventa); break;
		    case 2:
		         printf("\nPrecio de Compra: ");
		         scanf("%f",&a[donde].pcompra); break;
		    case 3:
		         printf("\nDescuento: ");
		         scanf("%i",&a[donde].descuento); break;
		    case 4:
...
int main(){
    time_t now;
	time(&now);         //para saber la fecha actual
	char fecha[20];
    ...
    almacen alma[MAX];              // es la fecha actual
	//----------------
		    ...
		    switch(opc1){
				case 1: // menu de administrador
		              do{
						  ...
						  switch(opc2){
			                 case 1:
			                      agregar(alma); cantidad_de_productos++; break;
			                 case 2:
